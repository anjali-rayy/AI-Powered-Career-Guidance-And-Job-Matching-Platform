const pathParts = window.location.pathname.split('/frontend/');
const rootBase = pathParts.length > 1 ? '/' + pathParts[0].split('/').filter(Boolean).join('/') + '/frontend' : '';
...
<img src="${rootBase}/assets/images/logo.png" alt="PathwayAI Logo">          </div>
    ...
    <div class="footer-links-grid">
      ...
      <div class="footer-col">
        ...
        <ul class="footer-col-list">
          <li><a href="${rootBase}/views/public/helpFaq.html">Help Center</a></li>
      ...
      <div class="footer-col">
        ...
        <ul class="footer-col-list">
          <li><a href="${rootBase}/views/public/privacy-policy.html">Privacy Policy</a></li>
          <li><a href="${rootBase}/views/public/terms-of-service.html">Terms of Service</a></li>
        </ul>
      </div>
    </div>
    <div class="footer-rule"></div>
